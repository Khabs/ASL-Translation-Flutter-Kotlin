...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final BottomNavigationView newBottomNavigation;
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull BottomNavigationView newBottomNavigation, @NonNull Toolbar toolbar,
      @NonNull View view) {
    this.rootView = rootView;
    this.fragmentContainer = fragmentContainer;
    this.navigation = navigation;
    this.newBottomNavigation = newBottomNavigation;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.new_bottom_navigation;
      BottomNavigationView newBottomNavigation = ViewBindings.findChildViewById(rootView, id);
      if (newBottomNavigation == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, fragmentContainer, navigation,
          newBottomNavigation, toolbar, view);
    }
